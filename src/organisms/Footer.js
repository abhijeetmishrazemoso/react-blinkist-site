...
function Footer() {
    ...
    return (
        <Container maxWidth="xl" style={{marginTop:25, paddingBottom:10,margin: 'auto',backgroundColor:'rgba(220,220,240,0.65)'}}>
            <Grid container direction="row" xl={8} lg={8} sm={10} style={{paddingTop:50,marginTop:50, margin:'auto',}}>
